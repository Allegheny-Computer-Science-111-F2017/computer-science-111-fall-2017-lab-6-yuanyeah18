...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labsix \
                                     --checkfiles ManipulateDna.java --fragments "println(" --fragmentcounts 7
  determine_exit_code $?
  # NOTE: There was something not working correctly for the size of output checks, removed this one for now
